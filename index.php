...
<body>
    <form action="index.php" name="reversedstring" method="post">
        <label for="">Enter a String to reverse</label>
...
<body>
    <form action="index.php" name="palindrome" method="post">
        <label for="">Enter a String to check if Palindrome</label>
...
<body>
    <form action="index.php" name="twonumsum" method="post">
        <label for="twonumsum">Enter a two numbers</label>
...
<body>
    <form action="index.php" name="twonumsum" method="post">
        <label for="twonumsum">Enter a postive number to check if its a multiple of 3</label>
        <input type="number" name="num1">
        <button type="submit">submit</button>
    </form>
</body>
...
<head>
    <title>Number Check Form</title>
</head>

<body>
    <form action="index.php" method="post">
        <label for="number">Enter a number to check if its positive or negative:</label>
